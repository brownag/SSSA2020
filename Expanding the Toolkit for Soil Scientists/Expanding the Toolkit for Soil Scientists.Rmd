...
If you need to operate on other groupings, splitting into `list` is a good option.
...
<br>
## {`aqp`} Soil Color
.center[####{`aqp`} has methods for soil data in<br>Munsell, sRGB and CIELAB color space.]
